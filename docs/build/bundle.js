...
var app = (function () {
  ...
  `);
    			...
    			add_location(button, file$b, 7, 0, 176);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
  ...
  `)) {
    ...
    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$b, create_fragment$b, safe_not_equal, { onClick: 0 });
    ...
    */
    ...
    const file$a = "src/pages/home/components/Greeting.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(source0, file$9, 99, 10, 4058);
    			...
    			attr_dev(img0, "class", "svelte-670kf1");
    			add_location(img0, file$9, 100, 10, 4129);
    			add_location(picture0, file$9, 98, 8, 4038);
    			attr_dev(source1, "srcset", "imgs/rv-small.webp");
    			attr_dev(source1, "type", "image/webp");
    			add_location(source1, file$9, 104, 12, 4337);
    			attr_dev(img1, "id", "rv");
    			...
    			attr_dev(img1, "class", "svelte-670kf1");
    			add_location(img1, file$9, 105, 12, 4404);
    			add_location(picture1, file$9, 103, 10, 4315);
    			attr_dev(div0, "class", "squirrel animate-squirrel svelte-670kf1");
    			add_location(div0, file$9, 108, 10, 4513);
    			attr_dev(div1, "id", "rv-squirrel-container");
    			attr_dev(div1, "class", "container hide");
    			add_location(div1, file$9, 102, 8, 4249);
    			attr_dev(div2, "class", "container");
    			add_location(div2, file$9, 97, 6, 4006);
    			attr_dev(div3, "id", "art");
    			attr_dev(div3, "class", "svelte-670kf1");
    			add_location(div3, file$9, 96, 4, 3985);
    			attr_dev(div4, "class", "container overflow-hidden");
    			add_location(div4, file$9, 95, 2, 3941);
    			attr_dev(div5, "id", "art-container");
    			attr_dev(div5, "class", "container svelte-670kf1");
    			add_location(div5, file$9, 94, 0, 3896);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div2, picture0);
    			append_dev(picture0, source0);
    			append_dev(picture0, t0);
    			append_dev(picture0, img0);
    			append_dev(div2, t1);
    			append_dev(div2, div1);
    			append_dev(div1, picture1);
    			append_dev(picture1, source1);
    			append_dev(picture1, t2);
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	const getBetterQualityImgSrc = img => __awaiter(void 0, void 0, void 0, function* () {
    		const loadedSrc = yield getImgCurrSrc(img);
    	...
    	const loadBetterQualityImg = (picture, timeout) => __awaiter(void 0, void 0, void 0, function* () {
    		const img = picture.querySelector("img");
    		const src = yield getBetterQualityImgSrc(img);

    		const blobUrl = yield loadImgWithTimeout(src, timeout).catch(e => {
    			if (e.name === "AbortError") ; else {
    				console.error(e); // console.log('Fetch aborted');
    			}
    		});
    		...
    		if (blobUrl) {
    			...
    			yield loadImg(blobUrl);

    			img.src = blobUrl;
    		}
    	});

    	const loadBetterQualityArt = () => __awaiter(void 0, void 0, void 0, function* () {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Art> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({
    		...
    		webpIsSupported,
    		getImgCurrSrc,
    		getBetterQualityImgSrc,
    		takeImgOutsideOfPicture,
    		loadBetterQualityImg,
    		loadBetterQualityArt
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$8, 10, 6, 352);
    			attr_dev(div0, "id", "btn-container");
    			attr_dev(div0, "class", "svelte-14jmdac");
    			add_location(div0, file$8, 12, 6, 442);
    			attr_dev(div1, "class", "div-tags text-container svelte-14jmdac");
    			add_location(div1, file$8, 8, 4, 289);
    			attr_dev(div2, "class", "home-text padding-15 body-tags svelte-14jmdac");
    			add_location(div2, file$8, 7, 2, 240);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
